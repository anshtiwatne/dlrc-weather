	...
	return (
		<div className="w-full px-4 py-1">
			<Accordion defaultExpandedKeys={['1']}>
				<AccordionItem id="1" title="Introduction">
					DLRC built the DLRC Weather app as an Open Source app. This
				...
				<AccordionItem id="2" title="Information Collection and Use">
				...
				<AccordionItem id="3" title="Log Data">
				...
				<AccordionItem id="4" title="Cookies">
				...
				<AccordionItem id="5" title="Service Providers">
				...
				<AccordionItem id="6" title="Security">
				...
				<AccordionItem id="7" title="Links to Other Sites">
				...
				<AccordionItem id="8" title="Children's Privacy">
				...
				<AccordionItem id="9" title="Changes to This Privacy Policy">
				...
				<AccordionItem id="10" title="Contact Us">
